...
const kThirdDarkColor = Color.fromRGBO(48, 48, 48, 1);
const kForthDarkColor = Color.fromRGBO(255, 255, 255, 1);
const kSecondaryLightColor = Colors.white38;

// Dark Mode
/*const kPrimaryDarkColor = Color.fromRGBO(0, 0, 0, 1);
const kSecondaryDarkColor = Color.fromRGBO(255, 160, 18, 1);
const kThirdDarkColor = Color.fromRGBO(255, 255, 255, 1);
const kForthDarkColor = Color.fromRGBO(179, 179, 179, 1);
const kSecondaryLightColor = Colors.white;
const kPrimaryLightColor = kForthDarkColor;
